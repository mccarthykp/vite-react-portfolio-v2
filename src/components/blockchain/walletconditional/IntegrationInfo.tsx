  ...
  return (
    <>
      {isConnected ? (
        ...
        <p className="flex mt-4 bg-neutral-300 dark:bg-opacity-0 bg-opacity-40 rounded-lg pr-2 dark:text-red-300 items-center font-rajdhani font-normal tracking-wide md:text-md text-sm">
